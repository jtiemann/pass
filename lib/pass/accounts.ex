defmodule Pass.Accounts do
  ...
  alias Pass.Accounts.{User, UserToken, UserNotifier}
  ...
  @doc """
  Gets a single user, returning `nil` if it does not exist.
  """
  def get_user(id), do: Repo.get(User, id)
  ...
  See `Pass.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Pass.Accounts.User.password_changeset/3` for a list of supported options.
